...
Usage:
    python prediction_analysis/visible_only/scripts/analyze_wrong_predictions.py

Outputs to prediction_analysis/visible_only/wrong_predictions/:
...
# Paths
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "prediction_analysis/visible_only/wrong_predictions")
