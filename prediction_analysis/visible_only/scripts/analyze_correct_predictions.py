...
Usage:
    python prediction_analysis/visible_only/scripts/analyze_correct_predictions.py

Outputs to prediction_analysis/visible_only/correct_predictions/:
...
# Paths
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "prediction_analysis/visible_only/correct_predictions")
