...
Usage:
    python prediction_analysis_visible_only/scripts/create_filtered_labels.py

Output:
    prediction_analysis_visible_only/filtered_labels/final_matched_visible_only.csv
    prediction_analysis_visible_only/filtered_labels/excluded_not_visible_videos.csv
"""
...
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "prediction_analysis_visible_only/filtered_labels")
