...
Usage:
    python prediction_analysis_visible_only/scripts/run_all_analyses.py [--dataset VAL|ALL|BOTH]
...
SCRIPTS_DIR = os.path.join(PROJECT_ROOT, "prediction_analysis_visible_only/scripts")
